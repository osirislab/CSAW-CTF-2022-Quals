...
# Alt Solution
By dropping the files into "encryptThese" and run Conti.exe again, it will process the files and automatically decrypt without further purposing. -@M0rtale

NOTE from Dhyey: This has been patched in the current version of `Conti.exe`
