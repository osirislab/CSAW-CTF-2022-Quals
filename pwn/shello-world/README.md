...
### Shello World
    ...
    I'm thinking 300-400 points for this challenge, depending on what other challenges are in the mix. Given Xiang is 
    writing stuff, probably 300 points. 
    ...
    TODO:
    1. Test that the exploit can jump to the BeKindToTheCSAWInfraTeam function and it works properly
    2. Clean up my exploit code
    3. Maybe write a how-to for setting up an EC2 instance to host the Windows Docker container if we decide it's necessary
    ...
    4. Should we give them source code or leave it out? I'm leaning towards leaving it out. Try reversing the DLL and .exe files and see how you like it.
    5. Can you find a way to mess with the flag or sensitive resources in the Docker container, once you get shell?
